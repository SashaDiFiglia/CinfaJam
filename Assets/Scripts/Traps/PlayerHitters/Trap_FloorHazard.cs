...
public class Trap_FloorHazard : MonoBehaviour, ITrap
{
     [SerializeField] private FloorHazardSO floorHazard;
    ...
    void Start() { Setup(floorHazard.damage, floorHazard.delayBetweenHits, floorHazard.dealsDamageOverTime); }
